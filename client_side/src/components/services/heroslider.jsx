      ...
      <div className="bg-[#fff] md:h-auto xl:h-[650px] max-sm:h-auto max-lg:h-[400px] w-full xl:relative overflow-hidden">
        ...
        <div className="hero-flex flex absolute top-0 left-0 w-full h-full  md:overflow-hidden ">
          <div className="bx1 xl:flex-[0.6] md:flex[0.6] lg:flex-[0.6]  h-full xl:mt-5 2xl:mt-10">
            <div className={`heading text-left max-sm:ml-10 md:ml-16 lg:ml-32 2xl:ml-44 md:mt-28 lg:mt-28 max-sm:mt-20 xl:mt-40 2xl:mt-48 transition-transform duration-1000 ${isAnimating ? 'translate-y-[-50px] opacity-0' : 'translate-y-0 opacity-100'}`}>
              ...
              <p className='font-lato md:hidden max-sm:pl-0 max-sm:pt-2 lg:block lg:-mt-0 text-[#939191] xl:text-xl lg:p-3 p-8 text-left '>{slides[currentSlide].text}</p>
            </div>
            ...
            <a href="https://wa.me/+918688664812?text=Hello%20there!%20I%20would%20like%20to%20make%20an%20appointment." target="_blank" rel="noopener noreferrer"
            className="">
              <button className="bg-white md:hidden ml-10 mt-2 hover:bg-green-600 hover:text-white active:bg-white active:text-gray-500 w-32 xl:text-xl lg:px-1 lg:font-semibold lg:rounded-2xl lg:py-3 xl:w-48 text-black py-2 px-4 rounded-md">
              Register Now
            </button></a>
            </div>
          </div>
