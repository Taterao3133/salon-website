...
function Services() {
  ...
  return (
    <div className="services-section  overflow-hidden ">
      <div className="tagline bg-[#422A3C] w-full xl:h-48 max-sm:h-48  justify-items-center  text-center ">
        <div className="container max-sm:m-auto xl:ml-96 pt-3 max-sm:pt-16 xl:pt-16 w-2/4  ">
            <h2 className="xl:text-5xl max-sm:text-2xl font-bold text-[#F7E5C1] pt-12 font-playfair">Services..</h2>
        </div>
      </div>
      <div className="d bg-[#ffffff] xl:pb-5 max-sm:pt-5 md:pt-10 xl:pt-10 h-auto xl:flex">
        <div className="r-c xl:flex-[50%] xl:ml-20 xl:p-8 ">
            ...
            <p className='font-raleway text-gray-800 max-sm:p-9 max-sm:text-sm xl:p-16  xl:-mt-5'>"Our clients choose us for our personalized care, expert services, 
        ...
        <div className="l-c flex-[50%] max-sm:p-9 xl:p-14">
      ...
      <div className="container w-full  bg-[#ffffff]">
        <div className="pricing-box w-[75%] m-auto max-sm:pt-10 xl:mt-20 xl:mb-16  h-auto   xl:flex">
          <div className="schedule  border-2 border-[#ccf1ea] xl:w-1/3 max-sm:p-4 xl:p-6">
            <h2 className='max-sm:text-2xl xl:text-5xl text-[#151515] tracking-wide font-bold text-center font-playfair max-sm:text-left max-sm:ml-5 xl:-ml-9 max-sm:mt-5 xl:mt-14'>Schedule</h2>
          ...
          <div className="h-image  xl:w-1/3 p-4">
