    ...
    {/* contact-details section */}
      <div className="cd_details  bg-[#FBF2E0] w-full max-sm:pb-3 xl:h-[670px] ">
        <div className="cd_inner_b w-60% m-auto max-sm:pt-5 xl:pt-10 max-sm:h-auto xl:h-4/5">
         ...
         <form onSubmit={handleSubmit} className="cdInner_bx shadow-lg m-auto rounded-2xl bg-[#ffff] max-sm:w-5/6 xl:w-2/5 h-auto max-sm:p-6 xl:p-20 max-sm:space-y-1 xl:space-y-2">
                        <div className="cdInput border-2 border-[#555555] max-sm:h-9 xl:h-12 max-w-full">
                            ...
                            <input 
                                ...
                                className='w-full h-full max-sm:pl-7 max-sm:text-xs xl:pl-10 font-sans'
                                placeholder='Name'
                                required
                            />
                        </div>
                        ...
                        <div className="btn border-2 cursor-pointer border-[#555555] max-sm:h-9 xl:h-12 max-sm:w-4/5 max-sm:m-auto xl:w-full text-center bg-[#422A3C] text-white">
