  ...
  <div className="home-section  overflow-hidden">
     ...
     <div className="d bg-gray-100 md:mt-32  lg:mt-10 xl:pb-16 max-sm:pt-5 max-sm:pb-6 md:pt-10 xl:pt-10 h-auto xl:flex">
        ...
        <div className="r-c xl:flex-[50%] max-sm:mt-8 md:p-8 md:ml-10 md:mt-56 xl:-ml-24 xl:mt-12  xl:p-8 ">
            ...
            <button className='bg-[#cef1ea] xl:mt-6 max-sm:mt-3  md:mt-5 max-sm:ml-9 max-sm:text-sm  max-sm:hover:text-xl xl:text-base font-medium hover:text-lg border-[#cef1ea] font-lato p-3 rounded-full'>LEARN MORE</button>
